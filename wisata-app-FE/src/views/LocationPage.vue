...
const { keyword, listData, isLoading, queryParams } = storeToRefs(indexStore)
...
const toDetail = (val) => {
  router.push({ name: 'location-detail', params: { id: val.id, slug: val.slug } })
}
</script>
      ...
      <div class="flex justify-content-center">
        ...
        <div class="search-container">
          <span class="p-input-icon-left">
            ...
            <InputText @input="searchProperty($event)" class="content-input" placeholder="Search Location" />
  ...
  <section class="content-style">    
    <div class="" >
      <Card class="" style="border-radius: 3rem; margin-top: -10rem; border-bottom-left-radius: 0; border-bottom-right-radius: 0; height: auto;">
        <template #title>
          <span class="m-4">List Location</span>
        </template>
        <template #content>
          <div v-if="isLoading">
...
/* Add your styles here */
  ...
  .background-image {
    ...
    height: 50rem;
    background-image: url('https://images.unsplash.com/photo-1688742010517-73038ef0ddfc?q=80&w=1889&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');
  }
